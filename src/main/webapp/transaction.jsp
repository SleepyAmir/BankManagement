...
<head>
    ...
    <style>
        ...
        .card-header { background: linear-gradient(135deg, #0ea5e9, #2563eb); color: white; padding: 1.5rem; border: none; }
...
<div class="container py-5">
    <div class="main-card">
        <div class="card-header">
            <h4><i class="fas fa-exchange-alt"></i> New Transaction</h4>
        </div>
            ...
            <form action="transactions" method="post">
                <div class="form-row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="sourceAccountNumber" name="sourceAccountNumber">
                    </div>
                    <div class="mb-3">
                        <label for="destinationAccountNumber" class="form-label">Destination Account</label>
                        <input type="text" class="form-control" id="destinationAccountNumber" name="destinationAccountNumber">
                    </div>
                    <div class="mb-3">
                ...
                <div class="text-center mt-4">
                    <button type="submit" class="btn btn-info btn-lg text-white"><i class="fas fa-check-circle"></i> Process Transaction</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="table-container">
        <div class="card-header">
            <h4><i class="fas fa-list-ul"></i> Transaction History</h4>
        </div>
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                <c:forEach var="tx" items="${sessionScope.transactionList}">
                    <tr>
                        <td>${tx.transactionId}</td>
                        <td>${tx.transactionType}</td>
                        <td>${tx.amount}</td>
                        <td>${tx.timestamp}</td>
                        <td>${tx.sourceAccountNumber}</td>
                        <td>${tx.destinationAccountNumber}</td>
